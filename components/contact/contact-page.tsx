...
export function ContactPageContent() {
  return <>
    <section className="relative overflow-hidden bg-[#f8f8f5]">
      <div className="absolute inset-0 bg-cover bg-center lg:bg-[center_46%]" style={{backgroundImage:"url('https://images.unsplash.com/photo-1477587458883-47145ed94245?auto=format&fit=crop&w=2200&q=88')"}} aria-hidden="true"/>
