...
export function cleanDescription(value:unknown,fallback=DEFAULT_DESCRIPTION){const raw=String(value??"").replace(/\s+/g," ").trim();const invalid=!raw||raw==="undefined"||raw==="null"||raw==="[object Object]";const text=invalid?fallback:raw;return text.slice(0,160)}
