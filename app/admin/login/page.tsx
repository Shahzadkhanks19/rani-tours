    ...
    <main className="grid min-h-screen bg-[#f4f7f2] lg:grid-cols-[1.05fr_0.95fr]">
      <section className="hidden bg-[#073b25] p-12 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="max-w-xl">
          <p className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-2 text-sm text-white/75"><ShieldCheck className="size-4 text-[#b3df24]" /> Secure content management</p>
          <h1 className="text-5xl font-black leading-[1.05]">Manage the entire Rani Tours experience from one place.</h1>
          <p className="mt-6 max-w-lg text-lg leading-8 text-white/60">Packages, taxi services, destinations, fleet, enquiries, bookings, reviews and website content will live inside this CMS.</p>
        </div>
      ...
      <section className="flex items-center justify-center p-5 sm:p-8">
        <div className="w-full max-w-md rounded-[28px] border border-[#143124]/10 bg-white p-6 shadow-[0_24px_80px_rgba(20,49,36,0.10)] sm:p-9">
          ...
          <p className="text-sm font-bold uppercase tracking-[0.18em] text-[#0b6b3a]">Admin CMS</p>
